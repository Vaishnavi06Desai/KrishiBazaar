...
export class CartService {
  ...
  getCart(uid: any){
    return this.httpClient.get<any>("https://krishi-bazaar-service.herokuapp.com/v1/consumer/cart" + "?uid=" + uid);
  }

  getItem(prodId: any){
    return this.httpClient.get<any>("https://krishi-bazaar-service.herokuapp.com/v1/products/categories/items/item"+ "?id=" + prodId);
  }

  postCart(data: any){
    return this.httpClient.post<any>("https://krishi-bazaar-service.herokuapp.com/v1/consumer/cart", data)
  }
