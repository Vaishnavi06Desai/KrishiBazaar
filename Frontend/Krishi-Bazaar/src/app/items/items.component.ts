...
export class ItemsComponent implements OnInit {
  ...
  urls = {
    ...
    'default': "https://krishi-bazaar-service.herokuapp.com/v1/products/categories/items/items",
  };
  ...
  //   this.httpClient.post<any>("https://krishi-bazaar-service.herokuapp.com/v1/products/test", this.generatejson[this.generatejson.length - 1]).subscribe(res => {
  //     console.log("done");
  //   });
