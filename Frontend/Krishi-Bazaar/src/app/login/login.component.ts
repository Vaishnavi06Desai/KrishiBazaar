...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private httpClient: HttpClient,private cartser : CartService, private as : AuthService, private cs: CookieService, private ac: AppComponent) {
  }
